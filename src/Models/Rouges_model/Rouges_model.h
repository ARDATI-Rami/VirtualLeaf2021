...
class Rouges_model : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
        Q_PLUGIN_METADATA(IID "org.virtualleaf.Rouges_model")
...
public:
	...
	virtual QString DefaultLeafML(void) { return QString("Cambium_Rami.xml"); }
};
