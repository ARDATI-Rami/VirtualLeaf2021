...
ParameterDialog::ParameterDialog(QWidget *parent, Qt::WindowFlags f) : QDialog(parent,f) {
  ...
  division_axis_type_edit = new QLineEdit( QString("%1").arg(par.division_axis_type), this );
...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "division_axis_type", this ), 9, 10 );
  grid->addWidget( division_axis_type_edit, 9, 11 );
  grid->addWidget( new QLabel( " <b>Auxin transport and PIN1 dynamics</b>", this), 22, 2, 1, 2 );
  grid->addWidget( new QLabel( "source", this ),23, 2 );
  grid->addWidget( source_edit, 23, 3 );
  grid->addWidget( new QLabel( "D", this ),24, 2 );
  grid->addWidget( D_edit, 24, 3 );
  grid->addWidget( new QLabel( "initval", this ),3, 4 );
  grid->addWidget( initval_edit, 3, 5 );
  grid->setColumnMinimumWidth(5, 80);
  grid->addWidget( new QLabel( "k1", this ),4, 4 );
  grid->addWidget( k1_edit, 4, 5 );
  grid->addWidget( new QLabel( "k2", this ),5, 4 );
  grid->addWidget( k2_edit, 5, 5 );
  grid->addWidget( new QLabel( "r", this ),6, 4 );
  grid->addWidget( r_edit, 6, 5 );
  grid->addWidget( new QLabel( "kr", this ),7, 4 );
  grid->addWidget( kr_edit, 7, 5 );
  grid->addWidget( new QLabel( "km", this ),8, 4 );
  grid->addWidget( km_edit, 8, 5 );
  grid->addWidget( new QLabel( "Pi_tot", this ),9, 4 );
  grid->addWidget( Pi_tot_edit, 9, 5 );
  grid->addWidget( new QLabel( "transport", this ),10, 4 );
  grid->addWidget( transport_edit, 10, 5 );
  grid->addWidget( new QLabel( "ka", this ),11, 4 );
  grid->addWidget( ka_edit, 11, 5 );
  grid->addWidget( new QLabel( "pin_prod", this ),12, 4 );
  grid->addWidget( pin_prod_edit, 12, 5 );
  grid->addWidget( new QLabel( "pin_prod_in_epidermis", this ),13, 4 );
  grid->addWidget( pin_prod_in_epidermis_edit, 13, 5 );
  grid->addWidget( new QLabel( "pin_breakdown", this ),14, 4 );
  grid->addWidget( pin_breakdown_edit, 14, 5 );
  grid->addWidget( new QLabel( "pin_breakdown_internal", this ),15, 4 );
  grid->addWidget( pin_breakdown_internal_edit, 15, 5 );
  grid->addWidget( new QLabel( "aux1prod", this ),16, 4 );
  grid->addWidget( aux1prod_edit, 16, 5 );
  grid->addWidget( new QLabel( "aux1prodmeso", this ),17, 4 );
  grid->addWidget( aux1prodmeso_edit, 17, 5 );
  grid->addWidget( new QLabel( "aux1decay", this ),18, 4 );
  grid->addWidget( aux1decay_edit, 18, 5 );
  grid->addWidget( new QLabel( "aux1decaymeso", this ),19, 4 );
  grid->addWidget( aux1decaymeso_edit, 19, 5 );
  grid->addWidget( new QLabel( "aux1transport", this ),20, 4 );
  grid->addWidget( aux1transport_edit, 20, 5 );
  grid->addWidget( new QLabel( "aux_cons", this ),21, 4 );
  grid->addWidget( aux_cons_edit, 21, 5 );
  grid->addWidget( new QLabel( "aux_breakdown", this ),22, 4 );
  grid->addWidget( aux_breakdown_edit, 22, 5 );
  grid->addWidget( new QLabel( "kaux1", this ),23, 4 );
  grid->addWidget( kaux1_edit, 23, 5 );
  grid->addWidget( new QLabel( "kap", this ),24, 4 );
  grid->addWidget( kap_edit, 24, 5 );
  grid->addWidget( new QLabel( "leaf_tip_source", this ),3, 6 );
  grid->addWidget( leaf_tip_source_edit, 3, 7 );
  grid->setColumnMinimumWidth(7, 80);
  grid->addWidget( new QLabel( "sam_efflux", this ),4, 6 );
  grid->addWidget( sam_efflux_edit, 4, 7 );
  grid->addWidget( new QLabel( "sam_auxin", this ),5, 6 );
  grid->addWidget( sam_auxin_edit, 5, 7 );
  grid->addWidget( new QLabel( "sam_auxin_breakdown", this ),6, 6 );
  grid->addWidget( sam_auxin_breakdown_edit, 6, 7 );
  grid->addWidget( new QLabel( "van3prod", this ),7, 6 );
  grid->addWidget( van3prod_edit, 7, 7 );
  grid->addWidget( new QLabel( "van3autokat", this ),8, 6 );
  grid->addWidget( van3autokat_edit, 8, 7 );
  grid->addWidget( new QLabel( "van3sat", this ),9, 6 );
  grid->addWidget( van3sat_edit, 9, 7 );
  grid->addWidget( new QLabel( "k2van3", this ),10, 6 );
  grid->addWidget( k2van3_edit, 10, 7 );
  grid->addWidget( new QLabel( "", this), 11, 6, 1, 2 );
  grid->addWidget( new QLabel( " <b>Integration parameters</b>", this), 12, 6, 1, 2 );
  grid->addWidget( new QLabel( "dt", this ),13, 6 );
  grid->addWidget( dt_edit, 13, 7 );
  grid->addWidget( new QLabel( "rd_dt", this ),14, 6 );
  grid->addWidget( rd_dt_edit, 14, 7 );
  grid->addWidget( new QLabel( "movie", this ),15, 6 );
  grid->addWidget( movie_edit, 15, 7 );
  grid->addWidget( new QLabel( "nit", this ),16, 6 );
  grid->addWidget( nit_edit, 16, 7 );
  grid->addWidget( new QLabel( "maxt", this ),17, 6 );
  grid->addWidget( maxt_edit, 17, 7 );
  grid->addWidget( new QLabel( "rseed", this ),18, 6 );
  grid->addWidget( rseed_edit, 18, 7 );
  grid->addWidget( new QLabel( "", this), 19, 6, 1, 2 );
  grid->addWidget( new QLabel( " <b>Meinhardt leaf venation model</b>", this), 20, 6, 1, 2 );
  grid->addWidget( new QLabel( "constituous_expansion_limit", this ),21, 6 );
  grid->addWidget( constituous_expansion_limit_edit, 21, 7 );
  grid->addWidget( new QLabel( "vessel_inh_level", this ),22, 6 );
  grid->addWidget( vessel_inh_level_edit, 22, 7 );
  grid->addWidget( new QLabel( "vessel_expansion_rate", this ),23, 6 );
  grid->addWidget( vessel_expansion_rate_edit, 23, 7 );
  grid->addWidget( new QLabel( "d", this ),24, 6 );
  grid->addWidget( d_edit, 24, 7 );
  grid->addWidget( new QLabel( "e", this ),3, 8 );
  grid->addWidget( e_edit, 3, 9 );
  grid->setColumnMinimumWidth(9, 80);
  grid->addWidget( new QLabel( "f", this ),4, 8 );
  grid->addWidget( f_edit, 4, 9 );
  grid->addWidget( new QLabel( "c", this ),5, 8 );
  grid->addWidget( c_edit, 5, 9 );
  grid->addWidget( new QLabel( "mu", this ),6, 8 );
  grid->addWidget( mu_edit, 6, 9 );
  grid->addWidget( new QLabel( "nu", this ),7, 8 );
  grid->addWidget( nu_edit, 7, 9 );
  grid->addWidget( new QLabel( "rho0", this ),8, 8 );
  grid->addWidget( rho0_edit, 8, 9 );
  grid->addWidget( new QLabel( "rho1", this ),9, 8 );
  grid->addWidget( rho1_edit, 9, 9 );
  grid->addWidget( new QLabel( "c0", this ),10, 8 );
  grid->addWidget( c0_edit, 10, 9 );
  grid->addWidget( new QLabel( "gamma", this ),11, 8 );
  grid->addWidget( gamma_edit, 11, 9 );
  grid->addWidget( new QLabel( "eps", this ),12, 8 );
  grid->addWidget( eps_edit, 12, 9 );
  grid->addWidget( new QLabel( "", this), 13, 8, 1, 2 );
  grid->addWidget( new QLabel( " <b>User-defined parameters</b>", this), 14, 8, 1, 2 );
  grid->addWidget( new QLabel( "betaN", this ),15, 8 );
  grid->addWidget( betaN_edit, 15, 9 );
  grid->addWidget( new QLabel( "gammaN", this ),16, 8 );
  grid->addWidget( gammaN_edit, 16, 9 );
  grid->addWidget( new QLabel( "betaD", this ),17, 8 );
  grid->addWidget( betaD_edit, 17, 9 );
  grid->addWidget( new QLabel( "gammaD", this ),18, 8 );
  grid->addWidget( gammaD_edit, 18, 9 );
  grid->addWidget( new QLabel( "betaR", this ),19, 8 );
  grid->addWidget( betaR_edit, 19, 9 );
  grid->addWidget( new QLabel( "gammaR", this ),20, 8 );
  grid->addWidget( gammaR_edit, 20, 9 );
  grid->addWidget( new QLabel( "tau", this ),21, 8 );
  grid->addWidget( tau_edit, 21, 9 );
  grid->addWidget( new QLabel( "kt", this ),22, 8 );
  grid->addWidget( kt_edit, 22, 9 );
  grid->addWidget( new QLabel( "kc", this ),23, 8 );
  grid->addWidget( kc_edit, 23, 9 );
  grid->addWidget( new QLabel( "krs", this ),24, 8 );
  grid->addWidget( krs_edit, 24, 9 );
  grid->addWidget( new QLabel( "k", this ),3, 10 );
  grid->addWidget( k_edit, 3, 11 );
  grid->setColumnMinimumWidth(11, 80);
  grid->addWidget( new QLabel( "i1", this ),4, 10 );
  grid->addWidget( i1_edit, 4, 11 );
  grid->addWidget( new QLabel( "i2", this ),5, 10 );
  grid->addWidget( i2_edit, 5, 11 );
  grid->addWidget( new QLabel( "b4", this ),6, 10 );
  grid->addWidget( b4_edit, 6, 11 );
  grid->addWidget( new QLabel( "dir1", this ),7, 10 );
  grid->addWidget( dir1_edit, 7, 11 );
  grid->addWidget( new QLabel( "dir2", this ),8, 10 );
  grid->addWidget( dir2_edit, 8, 11 );
...
delete division_axis_type_edit;
delete source_edit;
delete D_edit;
delete initval_edit;
delete k1_edit;
...
QString tmpval;
  ...
  par.division_axis_type = division_axis_type_edit->text().toInt();
...
void ParameterDialog::Reset(void) {
  ...
  division_axis_type_edit->setText( QString("%1").arg(par.division_axis_type) );
